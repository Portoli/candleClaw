...
<body>
  ...
  <div id="container" class="container">
    <div id="contactDiv" class="row col-md-12 justify-content-md-center">
      <div class="col-sm-12 col-lg-7 mb-3 p-3">
        <div id="instration" style="">
          <div id="instrationTheme" class="Standard-Font">Kontakt</div>
          <div id="instrationText" class="">
            Pytania związne z projektami CandleClaw można wysyłać na podany email lub discord.
          </div>
        </div>
      </div>
      <div class="col-sm-12 col-lg-5 mb-3 p-3">
        <div id="contact" class="Standard-Font">
          <h4>Pracownicy:</h4>
          <div id="Kemir-Brick" class="contactBrick">
            <div class="brickAvatar"></div>
            <div class="brickInfo">
              <div class="brickText Standard-Font">
                <p>Discord:</p>Kemir#XXXX
              </div>
              <div class="brickText Standard-Font">
                <p>Email:</p>Kemir@fakeEmail.com
              </div>
            </div>
          </div>
          <div id="Portoli-Brick" class="contactBrick">
            <div class="brickAvatar"></div>
            <div class="brickInfo">
              <div class="brickText Standard-Font">
                <p>Discord:</p>Portoli#XXXX
              </div>
              <div class="brickText Standard-Font">
                <p>Email:</p>Portoli@fakeEmail.com
              </div>
            </div>
          </div>
        </div>
